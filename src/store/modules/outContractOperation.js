  ...
  setTableData(state, data) {
    ...
    state.tableData = data.outContracts.content.map((item, index) => {
      return {
        ...
        outContractCategory: item.outContractCategory ? item.outContractCategory.categoryName : undefined,
        outProjectCategory: item.outProjectCategory ? item.outProjectCategory.categoryName : undefined,
        outContractCategoryId: item.outContractCategory ? item.outContractCategory.categoryId : undefined,
        outProjectCategoryId: item.outProjectCategory ? item.outProjectCategory.categoryId : undefined,
